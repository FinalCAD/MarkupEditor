...
public class MarkupWKWebView: WKWebView, ObservableObject, WKScriptMessageHandler {
    ...
    public init(html: String? = nil, placeholder: String? = nil, selectAfterLoad: Bool = true, resourcesUrl: URL? = nil, id: String, markupDelegate: MarkupDelegate? = nil, configuration: MarkupWKWebViewConfiguration? = nil, backgroundColor: Color) {
        self.id = id
        super.init(frame: CGRect.zero, configuration: WKWebViewConfiguration())
        self.html = html
